...
var carisekil = 0;
var baza = ["https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/33/w/750/3918419526_1_1_1.jpg?ts=1677832637170", "https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/2/w/750/3918419526_6_1_1.jpg?ts=1676461934292", "https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/2/w/750/3918419526_6_2_1.jpg?ts=1676461931812", "https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/2/w/750/3918419526_6_3_1.jpg?ts=1676461936898", "https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/2/w/750/3918419526_6_4_1.jpg?ts=1676461955520", "https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/2/w/750/3918419526_6_5_1.jpg?ts=1676461955601", "https://static.zara.net/photos///2023/V/0/2/p/3918/419/526/2/w/750/3918419526_6_6_1.jpg?ts=1676461937267"];

for (var _i = 0; _i < baza.length; _i++) {
  document.querySelector(".mediaaa").innerHTML += "\n\n    <img src=\"".concat(baza[_i], "\" onclick = \"secs(").concat(_i, ")\">\n\n \n    ");
}

function secs(i) {
  document.querySelector(".blck img").src = baza[i];
  carisekil = i;
}

$(".blck img").mouseover(function () {
  $(".mediaaa").css({
    "visibility": "visible"
  });
});
$(".mediaaa").mouseover(function () {
  $(".mediaaa").css({
    "visibility": "visible"
  });
});
$(".blck img").mouseleave(function () {
  $(".mediaaa").css({
    "visibility": "hidden"
  });
});
$(".mediaaa").mouseleave(function () {
  $(".mediaaa").css({
    "visibility": "hidden"
  });
}); //  !Login!!!!!!!!!!!!!!!!!!!!!!
...
function changeToRegister() {
  var changeToRegisterBtn = document.querySelector('#changeToRegister');
  var changeToLogin = document.querySelector('#changeToLogin');
...
function changeToLogin() {
  var changeToLoginBtn = document.querySelector('#chnageToLogin');
  var loginForm = document.querySelector('#login');
  var registerForm = document.querySelector('#register');
