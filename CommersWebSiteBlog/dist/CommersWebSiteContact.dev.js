...
for (var _i = 0; _i < baza.length; _i++) {
  ...
  "\n    <div class=\"product__item__pic \" category=\"".concat(baza[_i].cat, "\" onclick=\"goster(").concat(_i, ")\">\n\n    <div class=\"hello\">\n        <div class=\"demo\">\n            <div class=\"back\">\n                <div class=\"product5 \">\n                    <i class=\"fa-solid fa-maximize\"></i>\n                    <i class=\"fa-solid fa-heart\"></i>\n                    <i class=\"fa-solid fa-bag-shopping\" onclick=\"elaveet(").concat([_i], ")\"></i>\n                    </div>\n                    </div>\n                    <img src=\"").concat(baza[_i].sekil, "\">\n\n             <h3>").concat(baza[_i].title, "</h3>\n             <span>$").concat(baza[_i].qiymet, "</span>\n        </div>\n    </div>\n    ");
}
